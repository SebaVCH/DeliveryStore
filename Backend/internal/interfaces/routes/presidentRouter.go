...
func SetupPresidentRouter(router *gin.Engine) {
	...
	protected.PATCH("/users/:email", presidentController.Delete)         //cambiar a patch
	protected.PUT("/users/:email", presidentController.UpdateAnyAccount) //usar el patch anterior para esta accion ademas de marcar como baneado
}
